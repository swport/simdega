...
<head>
    ...
    <title>B.Sc. Non-Vocational | Simdega College</title>
            ...
            <div class="container">
                <div class="inner-banner d-flex align-items-center justify-content-center">
                    <div class="heading text-center">
                        <h2>Non-Vocational Courses >> Bachelors Of Science</h2>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Bachelors in Zoology</td>
                                <td>I Sc(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1428/- (Exam and Reg excluded)</td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>02</strong>
                                </td>
                                <td>Bachelors in Botany</td>
                                <td>I Sc(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1428/- (Exam and Reg excluded)</td>
                            </tr>
