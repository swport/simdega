...
<head>
    ...
    <title>B.A. Non-Vocational | Simdega College</title>
            ...
            <div class="container">
                <div class="inner-banner d-flex align-items-center justify-content-center">
                    <div class="heading text-center">
                        <h2>Non-Vocational Courses >> Bachelors Of Arts</h2>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Bachelors in Hindi</td>
                                <td>I A/I Sc/I Com(10+2) (With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1115/-(Exam and Reg excluded)</td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>02</strong>
                                </td>
                                <td>Bachelors in English</td>
                                <td>I A/I Sc/I Com(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1115/-(Exam and Reg excluded)</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Bachelors in Political Science</td>
                                <td>I A/I Sc/I Com(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1115/-(Exam and Reg excluded)</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Bachelors in Anthropology</td>
                                <td>I A/I Sc/I Com(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1295/-(Exam and Reg excluded)</td>
                            </tr>
                            <tr>
                                <td>
                                    <strong>12</strong>
                                </td>
                                <td>Bachelors in Psychology</td>
                                <td>I A/I Sc/I Com(10+2)(With Minimum 45%)</td>
                                <td>3 Years	</td>
                                <td>1295/-(Exam and Reg excluded)</td>
                            </tr>
