                            ...
                            <ul class="navbar-nav u-header__navbar-nav">
                                ...
                                <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    ...
                                    <ul id="gallerySubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer animated fadeOut" aria-labelledby="blogMegaMenu" style="min-width: 230px; display: none;">
                                        <li><a href="<?=BASE_URL?>simdega-events.php" class="nav-link u-header__sub-menu-nav-link">Events</a> </li>
                                        <li><a href="<?=BASE_URL?>simdega-infrastructure.php" class="nav-link u-header__sub-menu-nav-link">Infrastructure</a> </li>
                                    </ul>
                                    <!-- End Submenu -->
                                </li>
                                <!-- End Gallery -->
                                ...
                                <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    ...
                                    <ul id="programmeSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer animated fadeOut" aria-labelledby="blogMegaMenu" style="min-width: 230px; display: none;">
                                        <li><a href="<?=BASE_URL?>vocational.php" class="nav-link u-header__sub-menu-nav-link">Vocational</a> </li>
                                        <li><a href="<?=BASE_URL?>non-vocational.php" class="nav-link u-header__sub-menu-nav-link">Non Vocational</a> </li>
                                    </ul>
                                    <!-- End Submenu -->
                                </li>
                                <!-- End Programme -->
                                ...
                                <li class="nav-item u-header__nav-item u-header__nav-last-item"><a href="<?=BASE_URL?>tendar.php" class="nav-link u-header__nav-link">Tender</a></li>
